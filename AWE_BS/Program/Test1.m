...
% Last Modified by GUIDE v2.5 20-May-2014 17:51:30
...
function edit1_WindowScrollWheelFcn(hObject, eventdata, handles)
 
h = handles.edit1;
%if ~(h == handles.Test1); return; end % exit if edit1 does not have the focus
