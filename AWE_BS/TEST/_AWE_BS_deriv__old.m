function [PIP_sdx,PIP_s2dx,PIP_s3dx,PIP_s4dx,smoothen2,threshold,editImage,peak,opt]=AWE_BS_deriv...
    (imName,imDir,normPix)

%&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
%Globals
global I_max cropLength ButterSample cutOff topcropLength;
%$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
%&&&&&&&&&&&&&           Allocate Memory                &&&&&&&&&&&&&&&&&&&
%$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
peak(1,1:2)=[0 0];
...
%$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
raw=imread(fullfile(imDir,imName)); 
GreyIm=rgb2gray(raw(cropLength+topcropLength:end-cropLength,cropLength:end-cropLength,:));
BlueIm=(raw(cropLength+topcropLength:end-cropLength,cropLength:end-cropLength,3));
GreenIm=(raw(cropLength+topcropLength:end-cropLength,cropLength:end-cropLength,2));
...
[minSlope  minSlopeIndex]=min(abs([pGrey(1) pGreen(1) pBlue(1)]));
if minSlopeIndex==1
